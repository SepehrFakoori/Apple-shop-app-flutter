...
import 'package:ecommerce_flutter_application/bloc/comment/comment_bloc.dart';
...
import 'package:ecommerce_flutter_application/bloc/product/product_bloc.dart';
...
class VariantContainerGenerator extends StatelessWidget {
  final List<ProductVariants> productVariantList;
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: const BorderRadius.all(Radius.circular(8)),
                  border: (_selectedIndex == index)
                      ? Border.all(width: 2, color: AppColors.blueIndicator)
                      : Border.all(width: 1, color: AppColors.grey),
                ),
                child: Padding(
